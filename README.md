...
#### 13. Carousel is created using [react-snap-carousel](https://github.com/richardscarrott/react-snap-carousel). Carousel drag scroll is implement using [react-use-draggable-scroll](https://github.com/rfmiotto/react-use-draggable-scroll). See my implementation [here](https://github.com/zehan12/Netflix-App/blob/main/src/components/show-carousel.tsx). 

### Follow and ask me questions at [@zehan12](https://twitter.com/zehan12_Dev).
